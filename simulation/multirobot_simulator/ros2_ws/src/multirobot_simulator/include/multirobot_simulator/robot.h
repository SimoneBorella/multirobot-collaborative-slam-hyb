...
public:
    ...
    void updateIMU(double rate);
    void publishOdometry();
    void publishIMU();
    void publishFootprintMarker();


    void publishWorldToMapTransform()
    {
...
private:
    ...
    std::normal_distribution<double> linear_bias_dist;
    std::normal_distribution<double> angular_bias_dist;

    double alpha;

    double prev_linear_vel;
    double imu_acceleration;
    double imu_angular_vel;

    std::default_random_engine generator;

    std::atomic<bool> state_update_thread_running;
